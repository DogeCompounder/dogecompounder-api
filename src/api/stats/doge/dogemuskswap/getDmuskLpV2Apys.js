...
const MasterChef = require('../../../../abis/doge/DMuskMasterChefV2.json');
const ERC20 = require('../../../../abis/ERC20.json');
const fetchPrice = require('../../../../utils/fetchPrice');
const pools = require('../../../../data/doge/dmuskLpPoolsV2.json');
...
export const getDmuskLpV2Apys = async () => {
  let apys = {};
  let apyBreakdowns = {};
...
const getMasterChefData = async () => {
  ...
  const blockRewards = new BigNumber(await masterchefContract.methods.omgPerBlock(true).call());
