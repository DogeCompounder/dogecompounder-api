...
const MasterChef = require('../../../../abis/doge/BoneMasterChefV2.json');
const ERC20 = require('../../../../abis/ERC20.json');
const fetchPrice = require('../../../../utils/fetchPrice');
const pools = require('../../../../data/doge/boneLpPoolsV2.json');
...
const masterchef = '0x7fB524301283BCc0dEf0FaECc19c490bCEeB67AC';
const oracle = 'tokens';
const oracleId = 'BONE';
const DECIMALS = '1e18';
...
export const getBoneLpV2Apys = async () => {
  let apys = {};
  let apyBreakdowns = {};
...
const getMasterChefData = async () => {
  ...
  const blockRewards = new BigNumber(await masterchefContract.methods.BonePerSecond().call());
